...
export const projects: Project[] = [
  {
    ...
    longDescription: [
      ...
      "A major test for the Aura system was the re:Invent homepage takeover on aws.amazon.com. I built the React recap component for it, a grouped content area with a left-side menu and dynamic right-side content, including keynote speaker cards and article summary patterns that had to perform under massive global traffic. The work included the data parsing and manifest configuration needed to support AEM authored content. I also updated the template's analytics events and coordinated with the Adobe Customer Journey Analytics (CJA) team to support valid dashboard reporting.",
      ...
      'Beyond feature work, I focus on the long-term health of the site. I implemented JSON-LD structured data support for special templates. I partnered with the content authoring team to align on a structured data tab, worked with QA to define Kiro skill coverage for structured data testing, and piloted the first full build, including the AEM implementation. I also worked with a third-party team on a site-wide accessibility audit, remediating Aura patterns to meet WCAG standards.',
    ],
  },
  {
    title: 'Alphasense',
    ...
    longDescription:
      'While at Instrument, I was one of four developers who rebuilt AlphaSense’s marketing site in roughly three months. I worked across both the Sanity Studio and the Next.js front end, turning Figma designs into reusable, authorable page modules by writing the schemas with light validations, frontend queries, and typed React components that let the marketing team compose pages on their own. My hands-on contributions included buttons and the CMS link type, shared card variants used across parent containers, resource pages, and configurable Marketo form overrides so authors could select forms directly. I also supported the migration mapping from old fields and pages to the new content model. Throughout the build, I raised the site’s accessibility, SEO, and performance standards using semantic HTML, accessible labels, Sanity SEO fields, and component best practices, contributing to 100 Lighthouse scores across performance, accessibility, best practices, and SEO. The platform runs on Next.js, React, TypeScript, and SCSS, deployed on Vercel with Sanity CMS powering content.',
