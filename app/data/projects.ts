...
export const projects: Project[] = [
  {
    ...
    longDescription: [
      ...
      "A major test for the Aura system was the re:Invent homepage takeover on aws.amazon.com. I built a high-visibility 'Daily Recap' component for the takeover, a grouped content area with a left-side menu and dynamic right-side content, including specialized keynote speaker cards and article summary patterns that had to perform under massive global traffic. Alongside the build, I updated the template's TypeScript analytics event payloads so new fields flowed through correctly, and coordinated with the Adobe Customer Journey Analytics (CJA) team to confirm every interaction was captured and reflected accurately in the reporting dashboards.",
